...
def run_fastqc(fastq_file_path, workspace_directory):
    ...
    fastqc_command = ["fastqc", "--outdir", output_directory_path, "--extract", fastq_file_path]
...
class FASTQCApp(BaseSpaceNativeApp):
    ...
    def do_work(self, workspace_directory, appsettings, output_builder):
        ...
        for fastq_set in sample.fastq_sets:
            ...
            exit_code, output_directory_path_1 = run_fastqc(fastq_set.read_1_file_path, workspace_directory)
            ...
            if fastq_set.is_paired:
                ...
                exit_code, output_directory_path_2 = run_fastqc(fastq_set.read_2_file_path, workspace_directory)
